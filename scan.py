...
def send_message(chat_id, text):
    token = "<TOKENBOT>" # kalo ga ada ga token ga jalan
...
def jamet1(url):
    try:
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek1.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/admin/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek2.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/assets/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek3.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/plugins/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek4.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/admin/js/tinymce/plugins/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek5.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/js/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek6.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/assets/js/tinymce/plugins/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek7.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/assets/admin/js/tinymce/plugins/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek8.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/assets/admin/filemanager/dialog.php'))
        ...
        if '<input type="hidden" id="cur_dir" value="' in cek9.text.encode('utf-8'):
            ...
            send_message("<CHAT_ID>", "GET: {}".format(url+'/scripts/filemanager/dialog.php'))
